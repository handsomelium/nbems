...
public class SecurityConstants
{
     ...
     * 项目编码字段
     */
    public static final String DETAILS_PROJECT_CODE = "project_code";
    
    /**
     * 是否微信字段
     */
    public static final String DETAILS_IS_WX = "is_wx";
    /**
     * 是否客服字段
     */
    public static final String DETAILS_IS_CUSTOMER = "is_customer";
